...
#           BLUETOOTH
bluetooth_work          = True                  #True   False  
bluetooth_speed         = 9600                  #BOUD
bluetooth_mac           = "00:18:91:D7:4E:8B"   #For Linux users
bluetooth_port          = "COM?"                #For Windows users
...
settings_hit_stretch    = 0                     #-255   0
settings_hit_power      = 255                   #0      255